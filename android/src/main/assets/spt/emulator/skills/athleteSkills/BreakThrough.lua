...
function BreakThrough:ctor(level)
    ...
    self.addDribbleConfig = Skill.lerpLevel(self.minAddDribbleConfig, self.maxAddDribbleConfig, level)
    ...
    self.buff = {
        ...
        abilitiesModifier = function(abilities, caster, receiver)
            abilities.dribble = abilities.dribble + receiver.initAbilities.dribble * self.addDribbleConfig
        end
    }
