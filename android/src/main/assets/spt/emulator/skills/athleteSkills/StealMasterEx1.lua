...
local StealMasterEx1 = class(Skill, "StealMasterEx1")
StealMasterEx1.id = "Z05_1"
StealMasterEx1.alias = "抢断大师"
...
function StealMasterEx1:ctor(level)
