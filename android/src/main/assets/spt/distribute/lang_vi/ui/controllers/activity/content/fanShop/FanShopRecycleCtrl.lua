...
function FanShopRecycleCtrl:OnClickRecycle()
    if self.sellNum > 0 and self.canRecycle then
        ...
        if self.sellItemData.itemType == ItemType.CardPiece then
        ...
        elseif self.sellItemData.itemType == ItemType.Card then
        ...
        pieceName = pieceName .. pieceQuality
            ...
            clr.coroutine(function()
                ...
                if api.success(response) then
                    ...
                    if self.sellItemData.itemType ~= ItemType.Card then
                        ...
                        local cardPiece = data.cost.cardPiece and data.cost.cardPiece[1]
