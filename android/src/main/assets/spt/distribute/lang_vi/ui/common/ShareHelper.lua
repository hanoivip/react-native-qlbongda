...
function ShareHelper.CaptrueCamera(shareType, playerName)
    ...
    local longText = playerName == nil and lang.trans(ShareConstants.LongText[shareType]) or lang.trans(ShareConstants.LongText[shareType], playerName)
    shareSpt:CreateScreenShot(screenTex, coldUpdateURL, longText, lang.trans(ShareConstants.ShortText[shareType]), function() ShareHelper.ScreenShotCallBack() end)
end
