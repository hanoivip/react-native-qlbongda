...
function HeroHallUpgradeView:UpdateView()
    ...
    -- 左侧雕像名字
    self.txtNameLeft.text = self.model:GetStatueCardName() .. " · " .. lang.transstr("hero_hall_statue") .. " " .. self.model:GetCurrLevelStatueQualityDesc() 
    -- 右侧雕像名字
    self.txtNameRight.text = self.model:GetStatueCardName() .. " · " .. lang.transstr("hero_hall_statue") .. " " .. self.model:GetNextLevelStatueQualityDesc()
