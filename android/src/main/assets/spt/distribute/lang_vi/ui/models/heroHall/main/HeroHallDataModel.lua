...
function HeroHallDataModel:GetStatueQualityDescByLevel(level)
    return self:GetStatueConfigByLevel(level).nameQuality .. " " .. self:GetStatueConfigByLevel(level).nameLevel
end
...
function HeroHallDataModel:GetAttributesByStatueData(hallID, statueData)
    ...
    local attributeType = self:GetHallConfigDataById(hallID).improveType or {}
