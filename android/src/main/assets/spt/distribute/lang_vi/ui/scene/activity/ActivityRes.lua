...
local ActivityResPath = 
{
    ...
    -- 超值多日礼盒
    TimeLimitMultiGetGift =
    {
        [1] = {
            Name = "multi_get_gift",
            PrefabPath = "Assets/CapstonesRes/Game/UI/Scene/Activties/MultiGetGift/MultiGetGiftBoard.prefab",
            CtrlPath = "ui.controllers.activity.content.multiGetGift.MultiGetGiftCtrl",
            ModelPath = "ui.models.activity.multiGetGift.MultiGetGiftModel"
        }
    },
}
