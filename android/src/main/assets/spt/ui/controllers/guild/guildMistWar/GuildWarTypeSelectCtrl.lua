...
function GuildWarTypeSelectCtrl:Init(guildInfo)
    ...
    self.view.onBtnBossClick = function() self:OnBtnBossClick() end
...
--点击公会BOSS
function GuildWarTypeSelectCtrl:OnBtnBossClick()
    res.PopScene()
    res.PushScene("ui.controllers.guild.guildBoss.GuildBossCtrl", self.model:GetGuildInfo().authority)
end
