...
function SupporterCtrl:OnBtnActive()
    ...
    if selfSpcid == 0 then
        ...
        local msg = lang.transstr("support_tip_2", cost, currencytypeName, supporterName, selfName)
        local cancelTxt = lang.transstr("support_abandon")
        local confirmTxt = lang.transstr("support_confirm")
        local tip1 = lang.transstr("support_tip_3")
        local tip2 = lang.transstr("support_tip_4")
