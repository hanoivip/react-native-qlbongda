...
local LockDetail = {
    ...
    -- 公会boss战
    { desc = lang.trans("guildBoss_lock"), stringDesc = lang.transstr("guildBoss_lock_msg", 1), getKey = function() return LockType.Guild_BossWar_Lock_01 end },
    { desc = lang.trans("guildBoss_lock"), stringDesc = lang.transstr("guildBoss_lock_msg", 2), getKey = function() return LockType.Guild_BossWar_Lock_02 end },
    { desc = lang.trans("guildBoss_lock"), stringDesc = lang.transstr("guildBoss_lock_msg", 3), getKey = function() return LockType.Guild_BossWar_Lock_03 end },
    -- 特殊赛事（上场）
