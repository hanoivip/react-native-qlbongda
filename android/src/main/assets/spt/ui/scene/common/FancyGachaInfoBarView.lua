...
function FancyGachaInfoBarView:RegModelHandler()
    ...
    EventSystem.AddEvent("ItemsMapModel_UpdateFromReward", self, self.EventItemListInfo)
...
function FancyGachaInfoBarView:RemoveModelHandler()
    ...
    EventSystem.RemoveEvent("ItemsMapModel_UpdateFromReward", self, self.EventItemListInfo)
