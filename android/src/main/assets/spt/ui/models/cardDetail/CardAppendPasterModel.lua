...
function CardAppendPasterModel:GetTrainingSkillExLvl()
    return self.pasterSkillData.tlvl or 0
end
...
function CardAppendPasterModel:GetLevelEx()
    local lvlEx = self:GetPasterSkillExLvl() + self:GetMedalSkillExLvl() + self:GetHerohallSkillExLvl() + self:GetTrainingSkillExLvl()
