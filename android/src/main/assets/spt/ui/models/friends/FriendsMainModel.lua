...
local FriendsBlockModel = require("ui.models.friends.FriendsBlockModel")
...
function FriendsMainModel:Init()
    ...
    self.friendsBlockModel = FriendsBlockModel.new()
...
function FriendsMainModel:GetFriendsBlockModel()
    return self.friendsBlockModel
end
