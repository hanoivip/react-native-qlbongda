...
function DemoMatchManager:OnDeadBallSceneStarts()
    ...
    ___matchUI.fightMenuManager:SetPanelActive(MatchConstants.CurrentUIPanel.SPECIAL_CONDITION, false)
...
function DemoMatchManager:OnMatchEvent(matchFrame)
    ...
    elseif self.matchEventCount == 2 then
        ...
        ___matchUI.fightMenuManager:SetPanelActive(MatchConstants.CurrentUIPanel.SPECIAL_CONDITION, true)
